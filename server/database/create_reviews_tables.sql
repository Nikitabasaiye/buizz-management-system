...
-- Creates tables for review management, helpful votes, reports, and rating summaries
...
CREATE TABLE IF NOT EXISTS reviews (
  ...
  organizer_response_date TIMESTAMP NULL,
  admin_edited BOOLEAN DEFAULT FALSE,
  admin_edited_by VARCHAR(36) NULL,
