...
// View approvals (admin & super_admin only)
...
// Admin review (admin & super_admin)
router.post('/:id/admin-review', authorize('admin', 'super_admin'), auditLog('approval:admin-review'), approvalController.adminReview);
