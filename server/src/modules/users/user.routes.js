...
router.get('/:id', authorizeSelfOrRoles('id', USER_ROLES.ADMIN), validate(getUserValidator), auditLog('user:read'), userController.getUserById);
router.put('/:id', authorizeSelfOrRoles('id', USER_ROLES.ADMIN), validate(updateUserValidator), auditLog('user:update'), userController.updateUser);
